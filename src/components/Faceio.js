...
export const { enroll, fetchAllErrorCodes, authenticate, restartSession } =
  new faceIO(process.env.REACT_APP_FACEIO_PUBLIC_ID);
...
const FaceioProvider = ({ children }) => {
  ...
  return (
    <FaceIOContext.Provider value={{ handleError, logout }}>
      {children}
